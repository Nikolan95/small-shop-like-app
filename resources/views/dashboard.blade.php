                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tr id="row{{ $product->id }}">
                                        ...
                                        <td>
                                            ...
                                            <a class="deleteproduct" data-toggle = "modal" data-target ="#deleteproduct" data-id ="{{ $product->id }}" data-name ="{{ $product->name }}"><i class="far fa-trash-alt text-danger"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
